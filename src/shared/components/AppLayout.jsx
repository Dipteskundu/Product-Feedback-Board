...
import { RequestManagerButton } from '../../features/manager-request';

const ROLE_BADGE_STYLES = {
  admin: 'bg-bug/10 text-bug',
  manager: 'bg-accent/10 text-accent',
  user: 'bg-ink-muted/10 text-ink-muted',
};
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col lg:flex-row">
      ...
      `}>
        ...
        {/* Manager Request Button for Users */}
        {isUser && (
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-1.5 py-0.5 text-[10px] font-semibold uppercase rounded ${ROLE_BADGE_STYLES[user.role] || ROLE_BADGE_STYLES.user}`}>
                    {user.role}
                  </span>
                </div>
